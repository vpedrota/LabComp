...
{
       0,    29,    29,    31,    40,    42,    43,    45,    51,    57,
      64,    74,    79,    86,    85,    99,   100,   106,   115,   117,
     123,   130,   137,   146,   148,   157,   159,   160,   161,   162,
     163,   165,   166,   168,   174,   182,   189,   194,   200,   206,
     208,   214,   213,   224,   231,   233,   238,   243,   248,   253,
     258,   264,   271,   273,   277,   282,   289,   291,   295,   300,
     301,   302,   303,   311,   310,   321,   322,   324,   333
};
#endif
...
static const char *const yytname[] =
{
  ...
  "WHILE", "MAIS", "MENOS", "VEZES", "SOBRE", "MENORQ", "MENORI", "MAIORQ",
  "MAIORI", "IGUAL", "DIF", "PONVIR", "VIRG", "EPAREN", "DPAREN", "ECOLCH",
  "DCOLCH", "ECHAVE", "DCHAVE", "RECEBE", "ID", "NUM", "ERROR", "$accept",
  "programa", "decl_lista", "decl", "id", "num", "var_decl", "tipo_espec",
  "fun_decl", "@1", "params", "param_lista", "param", "comp_decl",
  "local_decl", "stmt_lista", "stmt", "exp_decl", "selec_decl", "it_decl",
  "retorno_decl", "exp", "var", "@2", "simp_exp", "relacional", "soma_exp",
  "soma", "termo", "mult", "fator", "ativ", "@3", "args", "arg_lista", YY_NULLPTR
};
#endif
...
{
      -3,   -87,   -87,    21,    -3,   -87,   -87,    -4,   -87,   -87,
     -87,   -87,   -14,   -87,     0,     5,   -87,     9,    12,    33,
      28,    -4,    34,    39,   -87,   -87,    51,    37,    -3,    52,
     -87,   -87,   -87,   -87,    -3,   -87,    -4,     6,   -14,    54,
      20,    56,   -87,    16,   -87,   -10,   -87,   -87,   -87,   -87,
     -87,   -87,   -87,    59,    53,   -87,    55,    31,   -87,   -87,
      16,   -87,    60,    16,    61,    58,    63,   -87,    16,   -87,
     -87,   -87,   -87,   -87,   -87,   -87,   -87,    16,    16,   -87,
     -87,    16,    64,   -87,    65,   -87,    16,    16,   -87,   -87,
      57,    31,   -87,    32,    32,    66,   -87,    67,    62,    82,
     -87,   -87,   -87,    16,    32,   -87,   -87
};
...
{
     -87,   -87,   -87,    84,    -6,    77,    68,   -12,   -87,   -87,
     -87,   -87,    69,    71,   -87,   -87,   -86,   -87,   -87,   -87,
     -87,   -40,   -23,   -87,   -87,   -87,    15,   -87,    17,   -87,
      13,   -87,   -87,   -87,   -87
};
...
{
      62,    12,     1,    64,     2,    13,    21,    99,   100,    14,
      39,   -63,    40,   -41,    41,    26,    21,     1,   106,    20,
      82,     9,    36,    84,    11,    42,    18,    43,    88,    16,
      38,    30,    44,    19,    11,    16,    39,    43,    40,    61,
      41,    43,    79,    80,    11,    16,    95,    96,    11,    16,
     -16,    42,    25,    43,    89,    89,    27,    30,    89,    28,
      11,    16,    30,   105,    69,    70,    69,    70,    71,    72,
      73,    74,    75,    76,    29,    60,    33,    63,    67,    83,
      68,    86,   103,    85,    87,   104,    93,    94,    10,   102,
     101,    17,    90,     0,    92,    91,     0,    32,    31,     0,
       0,     0,    35
};

static const yytype_int8 yycheck[] =
{
      40,     7,     5,    43,     7,    19,    18,    93,    94,    23,
       4,    21,     6,    23,     8,    21,    28,     5,   104,     7,
      60,     0,    34,    63,    28,    19,    21,    21,    68,    29,
      36,    25,    26,    24,    28,    29,     4,    21,     6,    19,
       8,    21,    11,    12,    28,    29,    86,    87,    28,    29,
      22,    19,    19,    21,    77,    78,    22,    25,    81,    20,
      28,    29,    25,   103,     9,    10,     9,    10,    13,    14,
      15,    16,    17,    18,    23,    21,    24,    21,    19,    19,
      27,    23,    20,    22,    21,     3,    22,    22,     4,    22,
      24,    14,    77,    -1,    81,    78,    -1,    28,    27,    -1,
      -1,    -1,    34
};
...
static const yytype_int8 yystos[] =
{
      ...
      34,    28,    35,    19,    23,    40,    29,    36,    21,    24,
       7,    38,    41,    42,    43,    19,    35,    22,    20,    23,
      25,    44,    43,    24,    45,    37,    38,    46,    35,     4,
       6,     8,    19,    21,    26,    35,    36,    44,    47,    48,
      49,    50,    51,    52,    53,    55,    57,    59,    61,    62,
      21,    19,    52,    21,    52,    54,    63,    19,    27,     9,
      10,    13,    14,    15,    16,    17,    18,    56,    58,    11,
      12,    60,    52,    19,    52,    22,    23,    21,    52,    53,
      57,    59,    61,    22,    22,    52,    52,    64,    65,    47,
      47,    24,    22,    20,     3,    52,    47
};
...
#line 65 "cminus.y"
                        {
                       	...
                       	yyval->attr.vetor.nome = NomeSalvo;
                       	yyval->attr.vetor.tamanho = NumSalvo;
                       	yyval->lineno = lineno;
                       	yyval->type = Array;
                       	}
...
#line 124 "cminus.y"
				...
				yyval->attr.name = copyString(NomeSalvo);
				}
